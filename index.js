...
const { song2, song4 } = nestedMuppet.album.theMuppetMovie; // Destructuring song2 and song4
const { nestedJob, nestedPartner } = nestedMuppet; // Destructuring nestedJob and nestedPartner
